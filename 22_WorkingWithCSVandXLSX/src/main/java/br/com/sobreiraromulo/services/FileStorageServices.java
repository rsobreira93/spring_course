...
import br.com.sobreiraromulo.config.FileStorageConfig;
import br.com.sobreiraromulo.exceptions.FileNotFoundException;
...
public class FileStorageServices {
    ...
    public FileStorageServices(FileStorageConfig fileStorageConfig) {
        ...
        try {
            ...
            throw  new FileStorageException("Could not create directory where will be stored!", e);
        }
    }
