package br.com.sobreiraromulo.integrationtestes.controllers.withxml;
...
import br.com.sobreiraromulo.integrationtestes.dto.wrapper.xmlandyaml.PagedModelPerson;
...
class PersonControllerXmlTest extends AbstractIntegrationTest {
    ...
    void findAllTest() throws JsonProcessingException {
        ...
        assertEquals("Alma", personFour.getFirstName());
        assertEquals("McCheyne", personFour.getLastName());
        assertEquals("Apt 998", personFour.getAddress());
    ...
    void findByNameTest() throws JsonProcessingException {
        ...
        assertEquals("Noore", personFour.getLastName());
        assertEquals("Apt 363", personFour.getAddress());
        assertEquals("Female", personFour.getGender());
