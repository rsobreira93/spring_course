...
import br.com.sobreiraromulo.exceptions.ExceptionResponse;
...
public class CustomEntityResponseEntity extends ResponseEntityExceptionHandler {
    ...
    public final ResponseEntity<ExceptionResponse> handlerBadRequestExceptions(UnsupportedMathOperationException ex, WebRequest request) {
        ExceptionResponse response = new ExceptionResponse(
                new Date(),
                ex.getMessage(),
                request.getDescription(false)
