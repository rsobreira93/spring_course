...
import br.com.sobreiraromulo.integrationtestes.dto.wrapper.json.WrapperBookDTO;
...
class BookControllerJsonTest extends AbstractIntegrationTest {
    ...
    @Test
    @Order(2)
    void updateTest() throws JsonProcessingException, com.fasterxml.jackson.core.JsonProcessingException {
    ...
    @Test
    @Order(3)
    void findByIdTest() throws JsonProcessingException, com.fasterxml.jackson.core.JsonProcessingException {
    ...
    @Test
    @Order(5)
    void findAllTest() throws JsonProcessingException, com.fasterxml.jackson.core.JsonProcessingException {
