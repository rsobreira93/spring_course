...
class PersonControllerXmlTest extends AbstractIntegrationTest {
    ...
    void findAllTest() throws JsonProcessingException {
        ...
        assertEquals("Romulo", personOne.getFirstName());
        assertEquals("Sobreira", personOne.getLastName());
        assertEquals("Pau dos ferros - RN", personOne.getAddress());
        ...
        assertEquals("Ismael", personFour.getFirstName());
        assertEquals("Pereira", personFour.getLastName());
        assertEquals("Santa cruz - PB", personFour.getAddress());
